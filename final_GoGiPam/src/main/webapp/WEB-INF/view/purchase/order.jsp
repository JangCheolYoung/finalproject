...
$(document).ready(function () {
	...
	var element_wrap = document.getElementById('daum');
	...
	function addressList(res) {
		console.log(res); // data가 넘어옴 res로 json
		...
		$.each(res, function(index, value) {
			var source ='<div class="adrtable_content">'
					...
					+ '<input type="radio" id="adrSelect" name="adrtable_radio" style="width:20px; height: 20px; border-radius: -5px;"/>'
					+ '</div>'
    	...
    	<div class="modal-dialog modal-center" role="document">
        	...
        	<div class="modal-body" style="text-align: center; width: 598px; height: 533px;">
          		...
          		<div class="ordermodal_body">
          			<div class="ordermodal_table">
          				<div class="ordertable_header">
          					...
          					<div class="adr_title" style="margin-left: 125px;">주소지 정보</div>
          				</div>
          				...
          				<div id="adrtable_body" style="width:130%; height: 310px; overflow: hidden; overflow-y: scroll; display: inline-block; float: left;">
          					...
          					<div class="adrtable_content">
          						<div style="width: 568px; display: inline-block; float: left; height: 108px;">
          							...
          							<div class="adrtable_info1">
          								<div class="adrtable_info1_box" id="receiver_namebox">
          								${adrList.receiver_name}
          								</div>
          								<div class="adrtable_info1_box" id="receiver_telbox">
          								${adrList.receiver_tel}
          								</div>
          							</div>
          							
          							<div class="adrtable_info2">
          								<div id="postnum_box" style="display: none">${adrList.post_num}</div>
          								<div class="adrtable_info2_box" id="address_box">
          								${adrList.address}
          								</div>
          								<div class="adrtable_info2_box" id="address_detailbox">
          								${adrList.address_detail}
          								</div>
          							</div>
          							
          							<div class="adrtable_btnline">
          								<button type="button" id="adrAlterBtn" class="adrtable_btn" data-target="#orderModal2" data-toggle="modal" data-dismiss="modal">
          									변경
          								</button>
          								<button type="button" id="adrDeleteBtn" class="adrtable_btn">
          									삭제
          								</button>
          							</div>
          						</div>
          		...
          		<div class="ordermodal_submit">
        			<button id="adrselect_submitBtn" class="ordermodal_btn2">
        				선택하기
        			</button> 
        		</div>
        	...
        	<div class="modal-body" style="text-align: center; width: 598px; height: 533px">
          		...
          		<div class="ordermodal_table">
          			...
          			<div class="adrinputtable_box">
          				...
          				<input id='member_id' name="member_id" style="display: hidden" value="nananan1213@naver.com">	
          			</div>	 	 	          				
          		</div>
        		
        		<div class="ordermodal_submit">
        			<button id="recipient_offBtn" class="ordermodal_btn2" disabled="disabled" style="background-color: gray">
        				등록하기
        			</button>
        			
        			<button class="ordermodal_btn2" id="recipient_submitBtn" type="button" 
        				data-target="#orderModal" data-toggle="modal" data-dismiss="modal"  
        					style="display: none">
        				등록하기
        			</button>
        		</div>
